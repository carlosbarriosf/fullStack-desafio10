...
let libro1 = new Libro("Carrie", "Stephen King", "$2399", "9789871138999", "256", "Español", "foto.jpg", "El legendario debut de Stephen King, sobre una marginada adolescente y la venganza que ejerce sobre sus compañeros de clase.");
console.log(libro1)
...
let libro5 = new Libro("Cocinemos juntos", "Maru Botana", "$3.890,00", "9789876378697", "220", "Español", "677978.jpg", 'Maru cocina junto a sus hijos y amigos sus mejores recetas del día a día. Este manual con recetario ayudará a los jóvenes, a los recién mudados y a todo aquel que se inicia en la cocina a preparar los platos más deliciosos: bebidas, entradas, principales, panes, postres y tortas. Todo con los eximios sabores y la simplicidad de Maru Botana.');
